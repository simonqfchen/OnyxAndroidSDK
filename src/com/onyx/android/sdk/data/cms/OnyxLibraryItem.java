...
public class OnyxLibraryItem
{
    ...
    public static class Columns implements BaseColumns {
        ...
        public static ContentValues createColumnData(File file)
        {
            ...
            values.put(LAST_CHANGE, FileUtil.getLastChangeTime(file));
        ...
        public static void readColumnData(Cursor c, OnyxLibraryItem item)
        {
            if (!sColumnIndexesInitialized) {
                ...
                sColumLastChange = c.getColumnIndex(LAST_CHANGE);
            ...
            long last_change = c.getLong(sColumLastChange);
            ...
            item.setSize(size);
            item.setType(type);
            item.setLastChange(last_change);
        }
